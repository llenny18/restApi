...
<head>
  <meta charset="utf-8">
  <title>Regulatory Framework Question Config</title>
...
<div class="section">
  ...
  <div class="add-question-container">
    <form action="q6adda.php" method="post">
 ...
 <!-- Search Form -->
  ...
  <table id="table1" class="table">
    ...
    <tbody>
      ...
      // Topic mapping
      $topic_mapping = [
        "LBT" => "Law on Business Transactions",
        "Bouncing" => "Bouncing Checks (BP 22)",
        "Consumer" => "Consumer Protection",
        "Rehabilitation" => "Financial Rehabilitation and Insolvency",
        "PHCA" => "Philippine Competition Act",
        "Procurement" => "Government Procurement Law",
        "LBO" => "Law on Business Organizations",
        "LOBT" => "Law on Other Business Transactions",
        "Security Law" => "Labor and Social Security Laws",
        "Doing Business" => "Ease of Doing Business Act"
    ];
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>
                <a href='q6Edita.php?id={$row['reg_id']}'>
                  <button class='edit-button'>Edit</button>
                </a>
                <a href='q6Deletea.php?id={$row['reg_id']}'>
