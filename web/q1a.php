...
<div class="section">
  ...
  <div class="add-question-container">
    <form action="q1adda.php" method="post">
 ...
 <!-- Search Form -->
  ...
  <table id="table1" class="table">
    ...
    <tbody>
      ...
      // Topic mapping
      $topic_mapping = [
        "Fin_Rep" => "Development of Financial Reporting Framework",
        "Fin State" => "Conceptual Framework and Presentation of Financial Statements",
        "Key Accounting" => "Key Accounting Areas",
        "Other" => "Other Accounting Topics",
        "Specialized" => "Specialized Reporting"
    ];
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>
                <a href='q1Edita.php?id={$row['fin_id']}'>
                  <button class='edit-button'>Edit</button>
                </a>
                <a href='q1Deletea.php?id={$row['fin_id']}'>
