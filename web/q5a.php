...
<title>Taxation</title>
  <div class="add-question-container">
    <form action="q5adda.php" method="post">
 ...
 <!-- Search Form -->
  ...
  <table id="table1" class="table">
    ...
    <tbody>
      ...
      // Topic mapping
      $topic_mapping = [
        "Principles" => "Principles of Taxation",
        "Remedies" => "Tax Remedies",
        "Income Tax" => "Income Taxation",
        "Transfer Tax" => "Transfer Taxes",
        "Business Tax" => "Business Taxes",
        "Doc Stamp" => "Documentary Stamp Tax",
        "Excise Tax" => "Excise Tax",
        "Gov Tax" => "Local Government Taxation",
        "Prefer Tax" => "Preferential Taxation"
    ];
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>
                <a href='q5Edita.php?id={$row['tax_id']}'>
                  <button class='edit-button'>Edit</button>
                </a>
                <a href='q5Deletea.php?id={$row['tax_id']}'>
