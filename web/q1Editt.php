...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    // Assuming the account category is stored in a session or a variable
$accountCategory = $_SESSION['account_category']; // Replace this with how you store the account category

// Check the account category and set the appropriate link
if ($data["Categories"] == "teacher") {
    $link = 'listT.php';
...
<form class="section" method="post" enctype="multipart/form-data">
    ...
    <h3>Topic:</h3>
    <select name="topic">
        <option value="Fin_Rep" <?php echo $topic == 'Fin Rep' ? 'selected' : ''; ?>>Development of Financial Reporting Framework</option>
