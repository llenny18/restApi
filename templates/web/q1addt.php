...
<h1 class="white-text">Financial Accounting and Reporting</h1>
    <a href="q1t.php" class="back-button">&#8592; Back</a>
</div>
<form class="section" action="q1phpt.php" method="post" enctype="multipart/form-data">
    ...
    <div class="questionSection" id="questionSection1">
      ...
      <div class="topicInput">
        ...
        <select name="topic[]" required>
            <option value="Fin_Rep">Development of Financial Reporting Framework</option>
