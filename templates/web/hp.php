...
if (isset($_SESSION['student']) && $_SESSION['student'] === 'student') {
    ...
    $ID = $_SESSION['ID'];             // ID of the logged-in student
    $password = $_SESSION['password']; // Password of the logged-in student
} else {
...
<nav>
    <ul>
        <li><a href="ins.php">Start Exam</a></li>
        <li><a href="algoResult.php">Results & Recommendations</a></li>
    </ul>
</nav>
