...
<a href="listA.php" class="back-button" onclick="window.history.back();">&#8592; Back</a>

<!-- Add Questions Form -->
<div class="section">
  <h1>Advanced Financial Accounting and Reporting</h1>
  <div class="add-question-container">
    <form action="q2adda.php" method="post">
 ...
 <!-- Search Form -->
  ...
  <table id="table1" class="table">
    ...
    <tbody>
      ...
      // Topic mapping
      $topic_mapping = [
        "Part" => "Partnership Accounting",
        "Corporate" => "Corporate Liquidation",
        "Joint" => "Joint Arrangements (PFRS 11)",
        "Revenue" => "Revenue Recognition (PFRS 15)",
        "Home Office" => "Home Office, Branch, and Agency Transactions",
        "Combination" => "Business Combination (PFRS 3)",
        "Consolidated" => "Consolidated Financial Statements (PFRS 10)",
        "Derivatives" => "Derivatives and Hedging (PFRS 9)",
        "Translation" => "Translation of Foreign Currency Financial Statements (PAS 21/29)",
        "no profit" => "Not-for-Profit and Government Accounting",
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>
                <a href='q2Edita.php?id={$row['adv_id']}'>
                  <button class='edit-button'>Edit</button>
                </a>
                <a href='q2Deletea.php?id={$row['adv_id']}'>
