...
<form class="section" action="q6add.php" method="post">
  <h1>Regulatory Framework for Business Transactions</h1>
  ...
  <table id="table1" class="table">
    ...
    <tbody>
      ...
      while ($row = $result->fetch_assoc()) {
          ...
          echo "<td>
                <a href='/CPA/q6Edit.php?id={$row['reg_id']}'>
                  <button class='edit-button'>Edit</button>
                </a>
                <a href='/CPA/q6Delete.php?id={$row['reg_id']}'>
